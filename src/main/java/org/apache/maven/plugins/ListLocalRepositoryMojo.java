...
/**
 * Implementation of the clean-local-repository:list goal.
 * 
 * @goal list
 * 
 ...
 * @author sgu, pef, lab ..
 */
public class ListLocalRepositoryMojo extends AbstractLocalRepositoryMojo
{
	 ...
	 * 
	 * @return false in the current "list" goal context
	 */
